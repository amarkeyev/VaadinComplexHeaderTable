...
public class FilterTable extends CustomTable implements IFilterTable {
     ...
     * Note: Recreates the filter fields also!
     *
     * @param decorator An implementation of FilterDecorator to use with this
     ...
     *
     * @param generator FilterGenerator to use with this FilterTable. Remove by giving
     ...
     *
     * @param propertyId Property id for which to set the value
     * @param value      New value
     * @return true if setting succeeded, false if field was not found
     * @throws ConversionException exception from the underlying field
     */
     ...
     * ID.
     *
     * @param propertyId Property id for which to find the filter component.
    ...
    public Filterable getFilterable() {
        return getContainerDataSource() instanceof Filterable ?
